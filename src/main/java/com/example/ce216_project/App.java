...
// ... TAM SINIF İÇERİĞİ (canvas'tan çekilen) ...
...
public class App extends Application {
        ...
        adminBtn.setOnAction(e -> {
            if (!adminPane.isVisible()) {
                showLoginDialog(stage, () -> {
                    ...
                    toggleGroup.selectToggle(homeBtn); // login başarısızsa home'a dön
                });
            } else {
                adminPane.setVisible(true);
                homePane.setVisible(false);
    ...
    private ScrollPane createHomePane() {
        ...
        //box.setStyle("-fx-background-color: linear-gradient(to bottom, #f9f9f9, #e0e0e0);");
    ...
    private ScrollPane createSearchPane() {
        ...
        // Dropdown: Search Field Selection
